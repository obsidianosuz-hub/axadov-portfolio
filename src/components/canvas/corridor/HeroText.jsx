...
const HeroText = ({ position = [0, 0.3, 0] }) => {
    ...
    // Letter positions for AXADOV split effect
    const letters = useMemo(() => [
        { char: 'A', baseX: -1.25, splitDir: -2.5, delay: 0 },
        { char: 'X', baseX: -0.75, splitDir: -1.5, delay: 0 },
        { char: 'A', baseX: -0.25, splitDir: -0.5, delay: 0 },
        { char: 'D', baseX: 0.25, splitDir: 0.5, delay: 0 },
        { char: 'O', baseX: 0.75, splitDir: 1.5, delay: 0 },
        { char: 'V', baseX: 1.25, splitDir: 2.5, delay: 0 },
    ], []);

    // Tagline words for split effect
    const taglineWords = useMemo(() => [
        { text: '<', baseX: -1.7, splitDir: -2.5, delay: 0 },
        { text: 'senior', baseX: -1.1, splitDir: -1.5, delay: 0 },
        { text: 'frontend', baseX: -0.4, splitDir: -0.5, delay: 0 },
        { text: '&', baseX: 0.2, splitDir: 0.2, delay: 0 },
        { text: 'backend', baseX: 0.7, splitDir: 1.0, delay: 0 },
        { text: 'developer', baseX: 1.4, splitDir: 1.8, delay: 0 },
        { text: '/>', baseX: 2.0, splitDir: 2.5, delay: 0 },
    ], []);
