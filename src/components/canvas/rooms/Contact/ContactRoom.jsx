...
const ContactRoom = ({ showRoom, onReady, isExiting, isWarmup }) => {
    ...
    const handleMailSelect = () => {
        ...
        window.location.href = PROFILE_DATA.socials.gmail;
    ...
    return (
        <group ref={groupRef} position={[0, -0.7, -5]}>
            ...
            <SocialBarrel
                ...
                label="TELEGRAM"
                onClick={() => window.open(PROFILE_DATA.socials.telegram, '_blank')}
            ...
            <SocialBarrel
                ...
                texturePath="/textures/contact/beczka.webp"
                label="INSTAGRAM"
                onClick={() => window.open(PROFILE_DATA.socials.instagram, '_blank')}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />
            {/* GMAIL */}
            <SocialBarrel
                ...
                texturePath="/textures/contact/beczka.webp"
                label="GMAIL"
                onClick={() => window.open(PROFILE_DATA.socials.gmail, '_blank')}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />
            {/* TELEPHONE */}
            <SocialBarrel
                ...
                texturePath="/textures/contact/beczka.webp"
                label="TELEPHONE"
                onClick={() => window.open(PROFILE_DATA.socials.phone, '_blank')}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />
